...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/js<?php echo (ADMIN_PUB); ?>css/admin">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">栏目管理</span></div>
        </div>
        <div class="search-wrap">
            <div class="search-content">
                <form action="/js<?php echo (ADMIN_PUB); ?>css/admin/design/index" method="post">
            ...
            <form  name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        ...
                        <a id="batchDel" href="javascript:void(0)"><i class="icon-font"></i><input  form="myform" formaction="/index.php/Admin/Cate/batchdel" formmethod="post" type="submit" class="btn btn-primary btn2" value="批量删除"></a>
                        <a id="updateOrd" href="javascript:void(0)"><i class="icon-font"></i><input  form="myform" formaction="/index.php/Admin/Cate/sortcate" formmethod="post" type="submit" class="btn btn-primary btn2" value="更新排序"></a>
                    </div>
                </div>
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($cates)): $i = 0; $__LIST__ = $cates;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td><?php if($vo['parentid'] != 0 ): ?>|<?php endif; echo str_repeat('-', $vo['level']*4); echo ($vo["name"]); ?></td>
                            <td>
                            ...
                            <td>
                                ...
                                <a class="link-del" onclick="return confirm('确定删除此栏目及其子栏目？');" href="/index.php/Admin/Cate/del/id/<?php echo ($vo["id"]); ?>">删除</a>
                            </td>
